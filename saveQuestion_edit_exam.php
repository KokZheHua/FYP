<?php
    ...
    if ($noFirstSubmit == 'no') {
        ...
        $query = "INSERT INTO exam_data (quizz_title, quizz_description, teacher_id, time_limit_min, start_time, end_time)
            VALUES ('$quizzTitle', '$quizzDescription', '$id', $timeLimit, $startTime, $endTime)";
    ...
    $exam_id2 = $_SESSION['quizz_id_new'];
    ...
    foreach($student_classroom_ids as $student_classroom_id){
        $query_exam_question = "INSERT INTO exam_question (exam_id, question_id, student_classroom_id)
                VALUES ('$exam_id2', '$question_id', '$student_classroom_id')";
