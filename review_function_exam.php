...
<script>
    ...
    function displaySummary() {
        ...
        const titleElement = document.getElementById('titleExam');
        ...
        examContainer.appendChild(summaryMCQ);

        const summaryLongQuestion = document.createElement('p');

        let totalLongQuestion = examData.length - totalMCQ;
        ...
        examContainer.appendChild(summaryLongQuestion);
        ...
        examContainer.appendChild(summaryTotalMark);
    }
    ...
    function displaySideBarItem() {
        ...
        document.querySelectorAll('.side_bar_question').forEach((item, index) => {
            if(Array.isArray(examData[index].options)){
                totalMCQ++;
                if(examData[index].answer == userAnswerData[index].answer){
                    ...
                    totalMCQMark = totalMCQMark + parseInt(examData[index].mark);
                }else{
    ...
    function displayQuestion() {
        ...
        examContainer.appendChild(markElement);
