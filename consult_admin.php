<?php
    ...
    $query2 = "SELECT unread_admin FROM users WHERE user_name = '$user_name'";
    ...
    while ($row = mysqli_fetch_assoc($result2)) {
        ...
        if ($unread_admin == 1) {
            $query_update = "UPDATE users SET unread_admin = 0 WHERE user_name = '$user_name'";
...
<body class="w3-theme-l5">
    <div id="container" class="w3-card-4 w3-theme-l4">
        <h1 style="font-weight: bold;">Consult Admin</h1>
        <div id="chat-box"></div>
        <div>
    ...
    <script>
        ...
        const receiver = "<?php echo $admin_name?>";
