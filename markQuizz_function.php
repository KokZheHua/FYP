...
<script>
    ...
    function submitMark() {
        ...
        var current_quizz_id = <?php echo $quizz_id ?>;
        var current_student_classroom_id = <?php echo $student_classroom_id ?>;
        var xhr = new XMLHttpRequest();
        xhr.open('POST', 'submitMark.php', true);
        ...
        xhr.send('quizz_id=' + encodeURIComponent(current_quizz_id) + '&question_id=' + encodeURIComponent(current_question_id) + '&student_classroom_id=' + encodeURIComponent(current_student_classroom_id) + '&mark=' + encodeURIComponent(mark));
    }
