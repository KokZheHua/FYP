...
<html>
    ...
    <body>
        ...
        if(isset($_GET['classroom_abbreviation'])){
            ...
            echo '<form action="updateProfileProcess.php" method="POST">';
        }
        ?>
            <div class="screen-1">
				...
				<div class="footer">
                    <?php 
                        if ($role == 'student'){
                            ...
                            echo '<a href="teacher.php">Home</a>';
                        }
                    ?>
                    <?php
                        if(isset($_GET['classroom_abbreviation'])){
                            echo '<a href="'.$previous_page.'.php?&classroom='. $classroom_abbreviation .'">Back</a>';
                        }
                        else{
                            echo '<a href="'.$previous_page.'.php">Back</a>';
                        }
                    ?>
				</div>
			</div>
